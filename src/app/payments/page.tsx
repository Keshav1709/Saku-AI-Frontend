...
export default function PaymentsPage() {
  const amount = 40; // $40 as requested
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Secure your access to premium features with our trusted payment system
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">SSL Secured</h3>
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
                ...
                <p className="text-sm text-gray-600">Get immediate access after payment</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-sm text-gray-500">
              ...
              Protected by <span className="font-semibold text-gray-700">256-bit SSL</span>
            </p>
          </div>
        </div>
      </div>
